    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('login', models.CharField(max_length=255, null=True, unique=True, verbose_name='login')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('group_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gravitaround_app.FavouriteGroup')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gravitaround_app.User')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('group_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gravitaround_app.FavouriteGroup')),
                ('satellite_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gravitaround_app.Satellite')),
            ],
            options={
